...
# Greenlet and Client code from: https://github.com/uofa-cmput404/cmput404-slides/blob/master/examples/WebSocketsExamples/chat.py
...
class World:
    ...
    def clear(self):
        for listener in self.listeners:
            listener.put(json.dumps({'msg':'clear'}))
        self.space = {}
